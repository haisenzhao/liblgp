...
int RI::Check()
{
	...
	if (nb == 703)
	{
		//Functs::MAssert("int RI::Check()");
	}
	return nb;
}

void RI::Read(const string t, const string l, const string& name)
{
	if (l != name)
	{
...
int RI::NB(const string& name, const int t)
{
	if (ol)
	{
	...
	else
	{
		...
		ifile >> lmp >> tmp >> nb;
		RI::Read(lmp,tmp,name);
		return nb;
	}
}

void RI::Out(const string& name, int& t)
{
	string tmp, lmp; 
	if (ol)
	{
...
void RI::Out(const string& name, double& t)
{
	string tmp, lmp; 
	if (ol)
	{
...
void RI::Out(const string& name, bool& t)
{
	string tmp, lmp; 
	if (ol)
	{
...
void RI::Out(const string& name, string& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
//output path 
//pt:pref path
void RI::Out(const string& name, const string& pt, string& t)
{
	if (ol)
	{
		if (t.size() == 0)
...
void RI::Out(const string& name, VectorTI3& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, Vector1i1& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, Vector1d1& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, Vector1i2& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, Vector1d2& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, VectorPI1& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, const string& pt, std::vector<string>& t)
{
	if (ol)
	{
...
void RI::Out(const string& name, std::vector<string>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::vector <std::vector<string>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, VectorPI2& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<int, int>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<string, string>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<string, int>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::vector<std::pair<string, int>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<string, bool>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<int, std::tuple<int, int, int, int, int>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map <string, std::map<string, bool>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map <string, Vector1i1>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<int, TI3>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::vector<std::map <string, int>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::vector<std::map<int, TI3>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::vector<std::tuple<int, int, Vector1i1>>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, std::map<std::pair<int, int>, double>& t)
{
	string tmp, lmp; int nb;
	if (ol)
	{
...
void RI::Out(const string& name, Vector2d& t)
{
	string tmp, lmp; 
	if (ol)
	{
...
void RI::Out(const string& name, Vector3d& t)
{
	string tmp, lmp; 
	if (ol)
	{
...
void RI::Out(const string& name, glm::dmat4& t)
{
	string tmp, lmp;
...
void RI::Out(const string& name, Vector3d2& t)
{
	string tmp, lmp; int nb;
...
void RI::Out(const string& name, Vector2d1& t)
{
	string tmp, lmp; int nb;
...
void RI::Out(const string& name, Vector3d1& t)
{
	string tmp, lmp; int nb;
